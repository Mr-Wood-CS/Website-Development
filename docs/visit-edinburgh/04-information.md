# :material-database-outline: Lesson Four - Information Models
    ...
    <tr>
      <td>
        <ul>
          ...
          <li>Use fields to record the same details for each item.</li>
          <li>Choose useful characteristics for website content.</li>
          <li>Create information that can be reused in a one-page website.</li>
        </ul>
      </td>
      <td>
        <p>By the end of this lesson you will be able to:</p>
        <ul>
          <li>I can explain what an information model is.</li>
          <li>I can choose suitable fields for visitor information.</li>
          <li>I can complete rows using purposeful information.</li>
          <li>I can explain how an information model helps compare and organise content.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
<table class="keywords-table">
  ...
  <tbody>
    ...
    <tr>
      <td>Field</td>
      <td>A column in an information model that stores one type of information.</td>
    </tr>
    <tr>
      <td>Record</td>
      <td>One complete row of information about an item.</td>
    </tr>
    <tr>
...
## :material-table-large: Using an Information Model
...
## :material-shape-outline: Choosing Fields

The fields you choose should match the information your website needs.

For a `Visit Edinburgh` website, useful fields might include:

| Field | Why It Is Useful |
|-----------|-----------|
| Name | Shows what the attraction, place, or topic is called. |
| Category | Helps group similar items, such as attractions, transport, food, or tips. |
| Description | Gives the visitor useful information in your own words. |
| Location | Helps visitors understand where the place is. |
| Useful For | Links the information to your audience, such as families, first-time visitors, or sports fans. |
| Source URL | Records where the information came from. |

You do not need every possible field. Choose the fields that will help you plan and build your page.

---

## :memo: Task

Use your website plan, wireframe, and research notes to design an information model for the `Visit Edinburgh` website.
...
- Describe what fields and records are.
- Choose useful characteristics for visitor information.
- Create complete rows using research from reliable sources.
- Use the keywords information model, field, record, characteristic, and source URL correctly.
